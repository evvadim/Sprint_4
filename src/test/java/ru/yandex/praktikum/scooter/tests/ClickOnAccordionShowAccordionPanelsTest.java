...
public class ClickOnAccordionShowAccordionPanelsTest {
    ...
    public ClickOnAccordionShowAccordionPanelsTest(Browser browser,
                                                   int index,
                                                   String question,
                                                   String answer) {
    ...
    @Parameterized.Parameters (name = "Тестовые набор {index}: Вопрос: '{2}'")
