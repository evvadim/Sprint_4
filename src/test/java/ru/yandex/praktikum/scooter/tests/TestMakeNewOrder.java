...
public class TestMakeNewOrder {
    ...
    public TestMakeNewOrder(Browser browser,
    ...
    public static Object[][] getOrderData() {
        return new Object[][] {
                {new Chrome(), 0,"order", "Василий", "Самокатов", "Газетный пер., 17", "смол", "79876556789", "21.09.2024", 2, "серая", ""},
                {new Chrome(), 1,"order", "Ли", "Васильев", "Мытная ул., 31", "преобр", "79001116789", "1.09.2024", 2, "жемчуг", "очень надо"},
                {new Chrome(), 0,"order", "Джон", "Петров", "Историческая площадь, 1", "тага", "79001116789", "1.03.2025", 5, "чёрный", ""},
        };
    }
